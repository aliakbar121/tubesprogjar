...
def send_file(client_socket):
    try:
        print("pilih metode komunikasi")
        print("=====================================================")
        metod = input("unicast, multicast, atau broadcast?:")
        print("=====================================================")
        if metod == "unicast":
        ...
        if metod == 'multicast':
            ...
            print("File dikirim secara multicast.")
                ...
                client_socket.sendall(bytes(f"file:{file_info}", encoding='utf-8'))
                client_socket.sendall(file_data)
                print("File dikirim secara broadcast.")
                return
    ...
    while True:
        try:
            ...
            if message == "file":
                ...
                print("====================================================================================")
                print("1. perintah untuk mengirim pesan 'chat' > tekan enter\n2. perintah untuk kirim file 'file' >  tekan enter")
                print("====================================================================================")
        except Exception as e:
...
def main():
    ...
    server_address = ('10.217.22.193', 8000)  # Ganti dengan alamat IP mesin server
